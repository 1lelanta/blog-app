  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            text-gray-700'> Your own <span className='text-primary cursor-pointer'>blogging</span> <br/> platform.</h1>
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs'>This is your space to think, to share what matters to you, and to write freely. Whether it’s just one word or a long story, 
                this is where your story begins.</p>

                <form onSubmit={onSubmitHandler} className='flex justify-center max-w-lg mx-auto 
                    border border-gray-300 bg-white rounded overflow-hidden max-sm:scale-75'>
