...
const Newsletter = () => {
  return (
    ...
    my-32'>
        <h1 className='md:text-4xl text-2xl font-semibold'>The Journal Hub</h1>
        ...
        h-12'>
            ...
            outline-nonw w-full rounded-r-none px-3 text-gray-500' type="text" placeholder='Enter your email' required/>
